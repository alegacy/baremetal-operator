...
func (r *BareMetalSwitchReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, bmSwitch); err != nil {
		if k8serrors.IsNotFound(err) {
			...
			if err := updateSwitchConfigSecret(ctx, r.Client, req.Namespace, r.SwitchConfigsSecretName, r.SwitchCredentialSecretName, r.SwitchCredentialPath); err != nil {
	...
	if err := updateSwitchConfigSecret(ctx, r.Client, bmSwitch.Namespace, r.SwitchConfigsSecretName, r.SwitchCredentialSecretName, r.SwitchCredentialPath); err != nil {
